/* FossilaBranslen.jsx : 
   ...
   Outlet for FossilaBranslen route. All data for the route is handled seperately in SubjectContents.jsx via SubjectPage.jsx
...
export default FossilaBranslen;
